...
fun getStartQuestion(): MutableList<Question> {
    return mutableListOf(
        ...
        Question(
            ...
            answers = arrayListOf(
                "- Для абстрактного класса запрещено определение конструктора; - Абстрактный класс может расширить любой другой класс; - Вплоть до Java8 для инте",
                "- Для абстрактного класса разрешено определение конструктора; - Абстрактный класс может расширить любой другой не-final класс и реализовать не более",
                ...
                "- Члены абстрактного класса могут иметь любой модификатор доступа: public, protected, private, кроме модификатора доступа по-умолчанию; - Абстрактный класс может расширить любой другой не-final класс, но не может реализовывать и",
                "Нет ответа"
            ),
            rightAnswer = "- Для абстрактного класса разрешено определение конструктора; - Абстрактный класс может расширить любой другой не-final класс и реализовать не более"
        ),
        Question(
